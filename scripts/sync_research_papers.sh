#!/usr/bin/env bash
# sync_research_papers.sh — publish the research paper library (slate_snapshots key 'research_papers').
#
...
exec bash "$HOME/Desktop/diamondedge/scripts/publish_key.sh" research_papers
