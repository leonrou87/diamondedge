#!/usr/bin/env bash
# sync_unified_live.sh — publish the UNIFIED single-pick LIVE board (slate_snapshots key 'picks_unified_live').
#
...
exec bash "$HOME/Desktop/diamondedge/scripts/publish_key.sh" picks_unified_live
