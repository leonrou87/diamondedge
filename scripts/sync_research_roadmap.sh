#!/usr/bin/env bash
# sync_research_roadmap.sh — publish the research roadmap (slate_snapshots key 'research_roadmap').
#
...
exec bash "$HOME/Desktop/diamondedge/scripts/publish_key.sh" research_roadmap
