#!/usr/bin/env bash
# sync_live_picks.sh — publish the v4-beta LIVE grid board (slate_snapshots key 'picks_v4_beta_live').
#
...
exec bash "$HOME/Desktop/diamondedge/scripts/publish_key.sh" picks_v4_beta_live
