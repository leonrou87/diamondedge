#!/usr/bin/env bash
# sync_unified_history.sh — publish the UNIFIED single-pick HISTORY board (slate_snapshots key 'picks_unified').
#
...
exec bash "$HOME/Desktop/diamondedge/scripts/publish_key.sh" picks_unified
